...
Asena.addCommand({pattern: 'ALINSHAN', fromMe: false,dontAddCommandList: true}, (async (message, match) => {

    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "POOCHA SER ne tholpikkaan ningalkavilla. Jeevitathil POOCHA SER ne tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per POOCHA SER ne ,ninte per donkey, backi ellarum monkey😼😼";
...
r_text[13] = ".song adich thangalude fav song name para POOCHA SER  ath download aakki theraam";
...
r_text[18] = "enikk njan und POOCHA SER uyir";
